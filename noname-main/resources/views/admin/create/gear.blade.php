...
<x-app-layout>
    <div class="container mt-5">
        ...
        <form action="/app/admin/create/gear" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group mb-3">
                <input type="checkbox" name="for2012" class="form-check-input ml-2" id="checkTwelve">
                <label class="form-check-label ml-5" for="checkTwelve">Works on the 2012 client <i class="far fa-question-circle ml-2" value="0" data-toggle="tooltip" data-placement="top" title="Exclude this item from 2012 to prevent gameserver crashes. Be sure!"></i></label>
            </div>
