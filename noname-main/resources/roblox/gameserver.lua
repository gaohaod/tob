function start(placeId,url,port,webid)
    ...
    game:GetService("Players").PlayerAdded:connect(function(player)
        ...
        print("[PRESENCE] Presence added for user id " .. player.userId)
    end)
    ...
    game:GetService("Players").PlayerRemoving:connect(function(player)
        ...
        print("[PRESENCE] Presence removed for user id " .. player.userId)
    end)
    ...
    game:GetService("Players"):SetSysStatsUrl("http://")

    game.OnClose = function() pcall(function() game:HttpGet(url.."/GameServer/"..game.JobId.."/delete") end) end -- the server died dont keep it 
